...
public class UserFun extends Empleado{
    ...
    public UserFun(String nombre, String cedula, String direccion, String correo, String telefono, LocalDate fecha, double sueldo, String usuario, String contraseña) {
