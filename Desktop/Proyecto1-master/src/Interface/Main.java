...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       Fundacion f0 = new Fundacion();
        ...
        obser[0] = "hola";
        obser[1] ="XD";
        Veterinaria v0 = new Veterinaria("aniV","09856","efe.com");
        f0.getVeterinarias().add(v0);
        TamanioPerro t1 = TamanioPerro.valueOf("GRANDE");
        Animal a1 = new Perro(t1,hoy,"boby", "Mestizo", "Macho", 3600.5, 1, obser, 1);
        f0.getAnimalesEnAdopccion().add(a1);
        ...
        Perro g1 = (Perro)a1;
        GastosVeterinaria efexd = new GastosVeterinaria(a1,28.5,hoy);
        f0.getGastosv().add(efexd);
        ...
        Empleado e2 = new UserAdmi("0898753","userAdmi", "098632", "efe", "aespol@xd", "0758", hoy, 400, "yeii", "uwu");
        f0.AgragarEmpleado(e2);
